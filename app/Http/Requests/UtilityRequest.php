...
class UtilityRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'start_coords_x' => 'required_if:existing_start_coords_x,null|string',
            'start_coords_y' => 'required_if:existing_start_coords_y,null|string',
            'end_coords_x' => 'required_if:existing_end_coords_x,null|string',
            'end_coords_y' => 'required_if:existing_end_coords_y,null|string',
